...
The algorithm is in-progress and not yet perfect but still it just takes 6589 trials to find 4 out of 5 best items from a set of 100 items where one would need to make approx. 4 million trials with a pure random search to achieve the same local maximum.
